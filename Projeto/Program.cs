      ...
      private static  List<Dados> listaDados = new List<Dados>();
        static void Main(string[] args)
        {
            ...
            do
            {
                ...
                Console.WriteLine("Quantidades de filmes cadastrados = : {0}", listaDados.Count);
                ...
                switch (opc)
                {
                    ...
                    case "2":Console.WriteLine("Alterar");
                        ...
                        Dados modificar3 = listaDados.Find(x => x.Data == alterar);
                        modificar.Data = Console.ReadLine();
                        Console.Write("Digite o novo condigo de segurança: ");
                        Dados modificar4 = listaDados.Find(x => x.Segurança == float.Parse(alterar));
                        modificar.Segurança = float.Parse(Console.ReadLine());
                        break;
                    case "3":Console.WriteLine("Excluir");
                        Console.WriteLine("Qual ID: ");
                         string Guardar = Console.ReadLine();

                        Console.WriteLine("Tem certeza que deseja excluir? se sim (s) se não (n)");
                        string Guarda = Console.ReadLine();
        ...
        private static Dados incluir()
        {
           ...
           dados.Data = Console.ReadLine();
           Console.Write("Insira um numero de segurança: ");
           dados.Segurança = float.Parse(Console.ReadLine());
